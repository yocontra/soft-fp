...
SF64_SLEEF_INLINE bool is_snan_(double x) noexcept {
    const uint64_t b = bits_of(x);
    return ((b >> 52) & 0x7FF) == 0x7FF && (b & 0x000FFFFFFFFFFFFFULL) != 0 &&
           (b & 0x0008000000000000ULL) == 0;
}

SF64_SLEEF_INLINE bool isinf_(double x) noexcept {
    const uint64_t b = bits_of(x);
    return ((b >> 52) & 0x7FF) == 0x7FF && (b & 0x000FFFFFFFFFFFFFULL) == 0;
}

SF64_SLEEF_INLINE bool signbit_(double x) noexcept {
    return (bits_of(x) >> 63) != 0;
}

SF64_SLEEF_INLINE bool is_neg_zero(double x) noexcept {
    return bits_of(x) == 0x8000000000000000ULL;
}

SF64_SLEEF_INLINE double neg(double x) noexcept {
    return soft_fp64::internal::sf64_internal_neg(x);
}
SF64_SLEEF_INLINE double abs_(double x) noexcept {
...
// `NaN != x` is true in C++.
SF64_SLEEF_INLINE bool lt_(double a, double b) noexcept {
    return soft_fp64::internal::sf64_internal_fcmp(a, b, 4) != 0;
}
SF64_SLEEF_INLINE bool le_(double a, double b) noexcept {
    return soft_fp64::internal::sf64_internal_fcmp(a, b, 5) != 0;
}
SF64_SLEEF_INLINE bool gt_(double a, double b) noexcept {
    return soft_fp64::internal::sf64_internal_fcmp(a, b, 2) != 0;
}
SF64_SLEEF_INLINE bool ge_(double a, double b) noexcept {
    return soft_fp64::internal::sf64_internal_fcmp(a, b, 3) != 0;
}
SF64_SLEEF_INLINE bool eq_(double a, double b) noexcept {
    return soft_fp64::internal::sf64_internal_fcmp(a, b, 1) != 0;
}
SF64_SLEEF_INLINE bool ne_(double a, double b) noexcept {
...
SF64_SLEEF_INLINE double add_(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    return soft_fp64::internal::sf64_internal_add_rne(a, b, fe);
}
SF64_SLEEF_INLINE double sub_(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    return soft_fp64::internal::sf64_internal_sub_rne(a, b, fe);
}
SF64_SLEEF_INLINE double mul_(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    return soft_fp64::internal::sf64_internal_mul_rne(a, b, fe);
}
SF64_SLEEF_INLINE double div_(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    return soft_fp64::internal::sf64_internal_div_rne(a, b, fe);
}
SF64_SLEEF_INLINE double fma_(double a, double b, double c, sf64_internal_fe_acc& fe) noexcept {
    return soft_fp64::internal::sf64_internal_fma_rne(a, b, c, fe);
}
SF64_SLEEF_INLINE double sqrt_(double x, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE double pow2i(int q) noexcept {
...
SF64_SLEEF_INLINE double upper(double d) noexcept {
...
SF64_SLEEF_INLINE double mla(double x, double y, double z, sf64_internal_fe_acc& fe) noexcept {
    return fma_(x, y, z, fe);
}

// Multiply-subtract: SLEEF `mlapn(x, y, z) = x*y - z`.
SF64_SLEEF_INLINE double mlapn(double x, double y, double z, sf64_internal_fe_acc& fe) noexcept {
    return fma_(x, y, neg(z), fe);
}

// Integer-valued rounding: floor, via sf64_floor.
SF64_SLEEF_INLINE double rint_(double x) noexcept {
    return sf64_rint(x);
}

SF64_SLEEF_INLINE double trunc_(double x) noexcept {
...
SF64_SLEEF_INLINE double poly2(double x, double c1, double c0, sf64_internal_fe_acc& fe) noexcept {
    return mla(x, c1, c0, fe);
}

SF64_SLEEF_INLINE double poly3(double x, double c2, double c1, double c0,
                               sf64_internal_fe_acc& fe) noexcept {
    return mla(x, mla(x, c2, c1, fe), c0, fe);
}

SF64_SLEEF_INLINE double poly4(double x, double c3, double c2, double c1, double c0,
                               sf64_internal_fe_acc& fe) noexcept {
    return mla(x, mla(x, mla(x, c3, c2, fe), c1, fe), c0, fe);
}

SF64_SLEEF_INLINE double poly_array(double x, const double* coeffs, int n,
                                    sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD dd(double h, double l) noexcept {
    return DD{h, l};
}

// ddadd2: Knuth's TwoSum with no precondition on |hi| >= |lo|.
SF64_SLEEF_INLINE DD ddadd2_dd_dd(DD a, DD b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddadd2_dd_d_d(double a, double b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddadd2_dd_dd_d(DD a, double b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddadd2_dd_d_dd(double a, DD b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddmul_dd_d_d(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    const double hi = mul_(a, b, fe);
    const double lo = fma_(a, b, neg(hi), fe);
    return DD{hi, lo};
}

SF64_SLEEF_INLINE DD ddmul_dd_dd_d(DD a, double b, sf64_internal_fe_acc& fe) noexcept {
    const double hi = mul_(a.hi, b, fe);
    const double lo = fma_(a.hi, b, neg(hi), fe);
    return DD{hi, fma_(a.lo, b, lo, fe)};
}

SF64_SLEEF_INLINE DD ddmul_dd_dd_dd(DD a, DD b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddsqu_dd_dd(DD a, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddrec_dd_d(double b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddrec_dd_dd(DD b, sf64_internal_fe_acc& fe) noexcept {
...
// Division.
SF64_SLEEF_INLINE DD dddiv_dd_dd_dd(DD n, DD d, sf64_internal_fe_acc& fe) noexcept {
    const DD r = ddrec_dd_dd(d, fe);
    return ddmul_dd_dd_dd(n, r, fe);
}

// Normalise (renormalise hi+lo so |lo| <= ulp(hi)/2).
SF64_SLEEF_INLINE DD ddnormalize_dd_dd(DD a, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE double dd_to_d(DD a, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddscale_dd_dd_d(DD d, double s, sf64_internal_fe_acc& fe) noexcept {
    return DD{mul_(d.hi, s, fe), mul_(d.lo, s, fe)};
}

SF64_SLEEF_INLINE DD ddneg_dd_dd(DD a) noexcept {
...
SF64_SLEEF_INLINE DD ddabs_dd_dd(DD a) noexcept {
...
SF64_SLEEF_INLINE DD ddsub_dd_dd_dd(DD a, DD b, sf64_internal_fe_acc& fe) noexcept {
...
SF64_SLEEF_INLINE DD ddadd_dd_d_d(double a, double b, sf64_internal_fe_acc& fe) noexcept {
    const double s = add_(a, b, fe);
...
SF64_SLEEF_INLINE DD ddadd_dd_dd_d(DD a, double b, sf64_internal_fe_acc& fe) noexcept {
    const double s = add_(a.hi, b, fe);
...
SF64_SLEEF_INLINE DD ddadd_dd_d_dd(double a, DD b, sf64_internal_fe_acc& fe) noexcept {
    const double s = add_(a, b.hi, fe);
    const double v = sub_(s, a, fe);
...
SF64_SLEEF_INLINE DD ddadd_dd_dd_dd(DD a, DD b, sf64_internal_fe_acc& fe) noexcept {
    const double s = add_(a.hi, b.hi, fe);
    const double v = sub_(s, a.hi, fe);
...
SF64_SLEEF_INLINE double ddmul_d_dd_dd(DD x, DD y, sf64_internal_fe_acc& fe) noexcept {
